...
def scrape_with_selenium(url):
    ...
    # Establece el nombre del parajaro como nombre del json
    nombre_archivo_json = f"{nombrePajaro.replace(' ', '')}.json"
    ...
    with open(os.path.join("json", nombre_archivo_json), 'w', encoding='utf-8') as json_file:
        json.dump(bird_data, json_file, ensure_ascii=False, indent=4)
